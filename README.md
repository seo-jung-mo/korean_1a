...
1·2단원은 어휘와 표현, 문법 1·2, 활동 1·2의 필수 학습을 마치면 각 단계가 자동으로 완료됩니다. 완료 문구 옆의 ‘다시 학습하기’로 연습을 반복하거나 ‘다음’ 버튼으로 이동할 수 있습니다. 활동 2 다음에는 단원 정리·복습으로 연결됩니다. 다시 학습해도 획득한 진도와 XP는 유지되며 XP는 중복 지급되지 않습니다.
